    ...
    switch (this.status) {
      case this.STATE.LOADING:
        ...
        <div class="data">
          ...
          <span class="data_value skeleton"></span>
        </div>
        <div class="data">
      ...
      case this.STATE.SUCCESS:
        ...
        this.element.innerHTML = `
          <div class="data">
            <span class="data__title">ID</span>
            <span class="data_value">${id}</span>
          </div>
          <div class="data">
            <span class="data__title">E-mail</span>
            <span class="data_value">${email}</span>
          </div>
          <div class="data">
            <span class="data__title">Роль</span>
            <span class="data_value">${role}</span>
          </div>
          <div class="data">
            <span class="data__title">Пошта підтверджена?</span>
            <span class="data_value">${confirm}</span>
          </div>
        `
        break
